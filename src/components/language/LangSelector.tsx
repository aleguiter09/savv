    ...
    <>
      ...
      {loading ? (
        ...
        <button
          ...
          className="mt-4 w-full rounded-md bg-blue-600 py-2 text-sm font-semibold text-white focus:outline-none focus:ring focus:ring-gray-blue disabled:bg-gray-400 disabled:cursor-not-allowed"
          type="submit"
        >
          {t("confirm")}
        </button>
