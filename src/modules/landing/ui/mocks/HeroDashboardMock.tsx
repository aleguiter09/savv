...
export async function HeroDashboardMock() {
  ...
  return (
    <div
      aria-hidden="true"
      className="rounded-2xl border bg-surface p-3 shadow-sm sm:p-4"
    >
      <Card className="mb-3 border-b-4 border-b-primary px-4 py-3">
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
          <div>
            ...
            <p className="font-medium text-income">+3.200</p>
          </div>
          <div>
            <p className="text-muted-foreground">{t("expense")}</p>
            <p className="font-medium text-expense">−1.850</p>
          </div>
        </div>
      </Card>

      <Card className="mb-3 px-4 py-3 shadow-sm">
        <p className="mb-2 text-sm font-semibold">{t("recent")}</p>
        <ul className="space-y-2 text-sm">
          <li className="flex items-center justify-between">
            <span>{t("salary")}</span>
            <span className="font-medium text-income">+2.800</span>
          </li>
          <li className="flex items-center justify-between">
            <span>{t("groceries")}</span>
            <span className="font-medium text-expense">−64,50</span>
          </li>
          <li className="flex items-center justify-between">
            <span>{t("transfer")}</span>
            <span className="font-medium text-transfer">500</span>
          </li>
        </ul>
      </Card>
